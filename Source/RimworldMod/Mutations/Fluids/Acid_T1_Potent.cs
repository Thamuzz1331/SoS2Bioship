...
namespace RimWorld
{
    public class PotentAcid : IMutation
    {
        ...
        void IHediff.Apply(CompBuildingBodyPart target)
        {
            ...
            {
                target.parent.TryGetComp<CompMutableAmmo>().projectileDef = ThingDef.Named("Proj_PotentAcid");
                target.parent.TryGetComp<CompMutableAmmo>().fakeProjectileDef= ThingDef.Named("Bullet_Fake_PotentAcid");
            }
