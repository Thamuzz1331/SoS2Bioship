...
namespace RimWorld
{
    class Graphic_256_Bio : Graphic
    {
        ...
        {
            return new Graphic_256_Bio(this.subGraphic.GetColoredVersion(newShader, newColor, newColorTwo))
            {
                data = this.data
            };
        }
        ...
        public Graphic_256_Bio(Graphic subGraphic)
        {
